      ...
      <div className="container px-4">
        ...
        <div className="max-w-4xl mx-auto mb-16">
          <p className="text-lg text-muted-foreground leading-relaxed text-center">
            Изготавливаем функциональные и декоративные металлоконструкции для разных сфер применения.
Используем аргонную сварку и современные технологии, чтобы обеспечить надёжность и долговечность изделий.
Сотрудничаем с заказчиками и дизайнерами на всех этапах проекта. Более 1400 выполненных заказов с 2014 года.
